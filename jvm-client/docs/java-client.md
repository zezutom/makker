...
```java
import com.tomaszezula.makker.client.jvm.java.MakeClient;

// Connects to eu1.make.com
MakeClient makeClient = MakeClient.Companion.eu("REPLACE-WITH-YOUR-API-KEY");

// Connects to us1.make.com
MakeClient makeClient = MakeClient.Companion.us("REPLACE-WITH-YOUR-API-KEY");
```
...
Working with a client brings Make much closer to your code, and your local filesystem. The ability to create a new
scenario
...
Ultimately, you want to have a more fine-grained control over an existing scenario. Each scenario comprises a bunch of
modules.
You have the power to replace the content of a selected module.

For example, suppose there is a [Compose a String](https://www.make.com/en/help/tools/tools#compose-a-string)
transformer with your scenario.
The [Get Blueprint](#get-a-scenario-blueprint) call reveals that the module is identified as a module number `9` within
the scenario.
...
[Set module data](#set-module-data) gives you a lot of control over your scenarios. Naturally, you might want to be able
to
